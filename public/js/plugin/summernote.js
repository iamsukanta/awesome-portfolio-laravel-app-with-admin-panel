...
var dialog = renderer.create('<div class="modal customSummernoteModal" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    if (options.fade) {
        $node.addClass('fade');
    }
    $node.html([
...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        icons: {
            ...
            'indent': 'fa fa-outdent',
            'outdent': 'fa fa-indent',
